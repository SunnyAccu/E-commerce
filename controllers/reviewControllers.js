...
const createReview=async(req,res)=>{
    ...
    if(alreadySubmitted){
        throw new CustomError.BadRequestError('Already submitted review of the product')
    }
...
const getSingleReview=async(req,res)=>{
    ...
    const getreview=await Review.findOne({_id:reviewsId})
    if(!getreview){
        throw new CustomError.NotFoundError(`No review with id ${reviewsId}`)
    }
